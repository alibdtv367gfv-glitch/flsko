...
توجد واجهة موبايل عربية بمساحات: الرئيسية، إنشاء الصور والفيديو والموسيقى، مكتبة الصور والفيديو والمستندات، الحوار، والذاكرة. توجد مصادقة OAuth، ومحادثة وذاكرة ومصادر معرفة في قاعدة سحابية، وتخزين سحابي للنتائج والملفات. إنشاء الصورة يستخدم Gemini عندما يكون متاحًا، ثم مزود صورة مفتوحًا، ثم المزود المدمج كحل احتياطي. الفيديو مهيأ لخادم Wan 2.2 أو LTX لأن تشغيلهما بجودة احترافية يحتاج GPU سحابيًا. رفع الملفات يتم بعد تسجيل الدخول وبحد حجم مضبوط، ولا يقرأ الوكيل الملف إلا عند طلب المستخدم.
